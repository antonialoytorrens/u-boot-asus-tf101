...
static struct pmux_pingrp_config tegra3_pinmux_common[] = {
	...
	DEFAULT_PINMUX(KB_ROW6_PR6, KBC, UP, NORMAL, INPUT),	// RECHECK
	DEFAULT_PINMUX(KB_ROW7_PR7, KBC, UP, NORMAL, INPUT),
	DEFAULT_PINMUX(KB_ROW8_PS0, KBC, UP, NORMAL, INPUT),
	DEFAULT_PINMUX(KB_ROW9_PS1, KBC, UP, NORMAL, INPUT),	// RECHECK
	DEFAULT_PINMUX(KB_ROW10_PS2, KBC, UP, NORMAL, INPUT),
	DEFAULT_PINMUX(KB_ROW11_PS3, KBC, UP, NORMAL, INPUT),	// RECHECK
	...
	DEFAULT_PINMUX(KB_COL6_PQ6, KBC, UP, NORMAL, INPUT),	// RECHECK
...
//	DEFAULT_PINMUX(GMI_AD4_PG4, NAND, NORMAL, TRISTATE, OUTPUT),	// memory bootstrap
//	DEFAULT_PINMUX(GMI_AD5_PG5, NAND, NORMAL, TRISTATE, OUTPUT),	// memory bootstrap
...
//	DEFAULT_PINMUX(GMI_AD13_PH5, NAND, UP, NORMAL, INPUT),			// memory bootstrap
